...
log.info("start_call_CAS")
CAS(app, '/cas')
app.config['CAS_SERVER'] = 'https://sso.xxxxx.com/'
app.config['CAS_LOGIN_ROUTE'] = '/cas/login'
#app.config['CAS_AFTER_LOGIN'] = session['CAS_AFTER_LOGIN_SESSION_URL']
#app.config['CAS_AFTER_LOGIN'] = request.args.get("next")
#xxxxx end #
